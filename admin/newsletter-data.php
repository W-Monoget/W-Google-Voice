...
<head>
    ...
    <title>Newsletter Data Admin | SK Driving School</title>
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Newsletter Data</a></li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Newsletter Email Collection</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example4" class="display min-w850">
                                    ...
                                    <tbody>
                                    <?php
                                    $newsletter_data = $db_handle->runQuery("SELECT * FROM newsletter order by id desc");
                                    ...
                                    for ($i = 0; $i < $row_count; $i++) {
                                        ...
                                        <tr>
                                            <td><?php echo $i + 1; ?></td>
                                            <td>#<?php echo $newsletter_data[$i]["id"]; ?></td>
                                            <td><?php echo $newsletter_data[$i]["email"]; ?></td>
                                            <td>
                                                <?php
