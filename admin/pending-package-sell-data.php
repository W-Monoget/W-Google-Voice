...
<head>
    ...
    <title>Pending Package Sell Data Admin | SK Driving School</title>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example4" class="display min-w850">
                                    ...
                                    <tbody>
                                    <?php
                                    $package_sell_data = $db_handle->runQuery("SELECT * FROM billing_details where approve=3 order by id desc");
